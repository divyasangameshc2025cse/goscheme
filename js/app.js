...
async function updateHeaderNavState() {
  ...
  if (user && user.isProfileComplete) {
    ...
    userNavContainer.innerHTML = `
      <a href="notifications.html" class="nav-link" style="position: relative; margin-right: 0.5rem;" title="Notifications">
      ...
      <div class="user-menu-btn" onclick="window.location.href='profile.html'">
